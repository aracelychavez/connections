CLASS zcl_1_basic_class_tester_mac DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_1_basic_class_tester_mac IMPLEMENTATION.
...
*    line->* = `Sneaky Stuff I Injected`.
    ...
    data(class_Instance) = new zcl_1_basic_class_mac(  ).
...
*    out->write( class_Instance->my_second_method(  ) ).
    ...
    data(class_Instance_New) = new zcl_1_basic_class_mac(  ).
